...
<code>.تكرار تلقائي [ث] [نص]</code> – إرسال النص كل فترة
<code>.ايقاف التكرار</code> – إيقاف التكرار

<b>📝 أوامر المنشن:</b>
<code>.منشن</code> – منشن لجميع الأعضاء برسائل ترحيب
<code>.لاتمنشن</code> – إيقاف المنشن
<code>.منشن تفعيل</code> – تفعيل المنشن
<code>.منشن حالة</code> – عرض حالة المنشن

<code>.كتم</code> – كتم عضو بالرد
<code>.الغاء الكتم</code> – فك الكتم
<code>.قائمة الكتم</code> – عرض المكتومين
<code>.مسح الكتم</code> – مسح الكتم بالكامل

<code>.تقليد</code> – تفعيل التقليد بالرد
<code>.ايقاف التقليد</code> – إيقاف التقليد

<code>.تفعيل الترحيب</code> – تشغيل الترحيب
<code>.تعطيل الترحيب</code> – إيقاف الترحيب
<code>.وضع ترحيب [النص]</code> – تغيير نص الترحيب

<code>.صورة البروفايل</code> – إرسال آخر صورة شخصية

<code>.مؤقت</code> – تفعيل اسم مؤقت بالحساب
<code>.مؤقت توقف</code> – إيقاف الاسم المؤقت
<code>.اسم مؤقت قروب</code> – تفعيل اسم وقت للقروب
<code>.ايقاف اسم القروب</code> – إرجاع اسم القروب الأصلي
